...
int main(void)
{
    ...
    configASSERT(xTaskCreate( (TaskFunction_t) STATE_Profiler, "Profiler_task", 2048, NULL, tskIDLE_PRIORITY + 4UL, NULL) == pdPASS);
    configASSERT(xTaskCreate( (TaskFunction_t) STATE_Popup, "Popup_task", 512, NULL, tskIDLE_PRIORITY + 3UL, NULL) == pdPASS);
