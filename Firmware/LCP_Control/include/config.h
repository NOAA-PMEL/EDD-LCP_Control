...
#define SYSTEM_CDPP_TIMER                   ( 60.0f * 60.0f )    /* XXXX set to 60min for bench testing, revert to 4mins for field, Timer for getting stuck in critical depth piston position 300s*/
